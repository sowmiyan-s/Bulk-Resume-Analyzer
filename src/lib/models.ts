...
export const MODELS: ModelOption[] = [
  ...
  },
  {
    ...
    label: "DeepSeek R1 (NVIDIA NIM)",
    provider: "nvidia",
    tag: "Deep Reasoning",
    note: "1,000 Free Credits · Open weights reasoning powerhouse running on NVIDIA HGX H100 clusters.",
    browserDirect: true,
    supportsJsonMode: true,
    recommendedConcurrency: 2,
    recommendedCooldownSec: 2,
  },
  {
    ...
    label: "DeepSeek V3 (NVIDIA NIM)",
    provider: "nvidia",
    tag: "Recommended",
    note: "1,000 Free Credits · Ultra-fast 671B MoE open weights flagship running on NVIDIA NIM.",
    browserDirect: true,
    supportsJsonMode: true,
    recommendedConcurrency: 3,
    recommendedCooldownSec: 1,
  },
  {
    ...
    label: "Qwen 2.5 72B (NVIDIA NIM)",
    provider: "nvidia",
    tag: "Code & Tech",
    note: "1,000 Free Credits · Elite open source 72B coding & technical evaluation model.",
    browserDirect: true,
    supportsJsonMode: true,
    recommendedConcurrency: 3,
    recommendedCooldownSec: 1,
